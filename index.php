...
<html lang="pt-br">
  ...
  <body id="bodyindex">
	...
	<nav class="navbar navbar-dark navbar-expand-lg" style="background-color:#011E49; width: 100%;">
	  ...
	  <div   class="collapse navbar-collapse" id="navbarNav" >  
		<ul id="ul_index" class="navbar-nav">
		  <li id="li1_index" class="nav-item active licad">
			<i id="home_index" class="fas fa-home"></i><a id="a1_index"  class="nav-link"  href="#" >INÍCIO</a>
		  </li>
	  ...
	  <main id="main_index" class="container-fuid">
		  <br><br>
	  	<div id="divtext_index" class="container-fluid">
			<div id="divtext2_index" class="container-fluid">
			<h1 class="h1_index">UMA NOVA MANEIRA DE TRABALHAR</h1>
			<h1 class="h1cha_index">CHAMADA ONLINE DOM BOSCO</h1>
			...
			<button id="btn_agenda" class="btn_index" type="button" style="background-color: #2B4B05;" onClick="agenda();"><i id="calen_index" class="far fa-calendar-check"></i> VEJA NOSSO CALENDARIO </button><br ><br>
			
  			<button id="btn_site" class="btn_index" type="button" style="background-color: #2B3680;" onClick="site();"><i id="site_index" class="far fa-hand-point-right"></i> CONSULTE NOSSO SITE</button><br><br>
			
			<button class="btn_index" style="background-color: #2F2F2F" onClick="contraste()"><i id="contr_index" class="far fa-lightbulb"></i>CONTRASTE PRETO</button>
		  ...
		  <div id="divbtn2_index">
		  	<button class="btn2_index" type="button" style="background-color: #2B4B05;" onClick="agenda();"><i id="calen2_index" class="far fa-calendar-check"></i> VEJA NOSSO CALENDARIO</button><div style="padding-bottom: 10px;"></div>
			
  			<button class="btn2_index" type="button" style="background-color: #2B3680" onClick="site();"><i id="site2_index" class="far fa-hand-point-right"></i> CONSULTE NOSSO SITE</button><div style="padding-bottom: 10px;"></div>
			
			<button class="btn2_index trocacssbtn" style="background-color: #2F2F2F" onClick="contraste();"><i id="contr2_index" class="far fa-lightbulb"></i>CONTRASTE PRETO</button>
  		</div>
		 <div id="divtext3_index" class="text-center">
			 <h1 id="economize">Economize tempo &#10004; / Trabalhe com tecnologia &#10004; / Versatilidade &#10004;</h1> 
		  </div>
		  <br>
	  ...
	  <div class="container-fluid" style="width: 100%; height: 120px; background-color:#011E49; padding-top: 10px;" >
		<div id="div_imgroda1" class="text-center">
		 <a href="avaliar.php"><img id="imgroda1" class="float-left"  src="Midia-20190412T161604Z-001/Midia/rating%20(1).svg" alt="Icone pag. Avaliação" ></a>
		</div>
	...
	<img id="imgroda5" class="img-fluid" src="Midia-20190412T161604Z-001/Midia/services_img.jpg" alt="obra social">
	  </div>
	  <?php 
