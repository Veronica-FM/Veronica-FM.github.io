		...
		<main id="main_login" class="container-fluid">
			...
			<div id="meio_login" class="container">
				...
				<aside  id="divimg2_usu" class="container-fluid">
					<h1 id="h13_login">ALTERAR SENHA</h1>
					<div   id="divform_login" class="container-fluid">
						
					<form name="alterar" id="alterar" method="post" action="esqueceu_php.php" onSubmit="return valida();" >
						
						<label class="lbl_login" for="login"><i class="fas fa-users" style="font-size:0.8em;"></i> Login:</label><br>
						<input class="input_login" type="text" name="login" id="login" placeholder="Login já cadastrado" required style="margin-bottom: 13px;"><br>
						...
						<label class="lbl_login" for="nome_cont"><i class="fas fa-lock" style="font-size:0.8em;"></i> Nova senha:</label><br>
						
						<input class="input_login" type="password" name="senha" id="senha" placeholder="********"><br>
						
						<div class="text-center" style="margin-top: 45px;" id="divbtn_cont">
	...
	require("Footer_idexMen.php");
	  ...
	  <script>
		 ...
		 function valida(){
			...
			if(alterar.senha.value.length<6 || alterar.senha.value.length>10){
