...
<link rel="stylesheet" type="text/css" href="indexcss.css"> 
	  ...
	  <style>
		  ...
		  @media screen and (max-width:1000px){
			...
			margin-top: -10px;
			  ...
			  #a:hover{
				background-color: transparent;  color:#c9c9c9;
			  }
	...
	<nav class="navbar navbar-dark navbar-expand-lg" style="background-color:#011E49; width: 100%;">
	  ...
	  <div class="collapse navbar-collapse" id="navbarNav">
		<ul class="navbar-nav">
		  <li  class="nav-item licad">
			<a  class="nav-link" style="font-size: 1.2em;" href="cadastro.php">Cadastro</a>
		  </li>
			<li  class="nav-item licad" >
			<a  style="font-size: 1.2em;" class="nav-link" href="novo_curso.php">Curso</a>
			</li>
			<li  class="nav-item licad" >
			<a  style="font-size: 1.2em;" class="nav-link" href="relatorio.php">Relatório</a>
			</li>
			</li>
			 <li class="nav-item dropdown  licad" style="border: none;">
				...
				<div id="drop" class="dropdown-menu" aria-labelledby="navbarDropdown">
				  <a id="a" class="dropdown-item" href="nova_turma.php">Criar turma</a>
				<a id="a" class="dropdown-item" href="nova_turma.php" >Matricular Aluno</a>
				</div>
			 </li>
